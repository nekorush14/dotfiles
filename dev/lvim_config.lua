...
lvim.builtin.lualine.sections.lualine_b = { diagnostics, diff }
...
-- lvim.builtin.lualine.sections.lualine_y = { "language_server" }
lvim.builtin.lualine.sections.lualine_y = { components.lsp, components.treesitter }
